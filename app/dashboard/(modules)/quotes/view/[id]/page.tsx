...
export default async function QuoteViewPage({
  ...
  // 1. Récupération de le devis (Sécurisée par organizationId)
          ...
          <div>
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                ...
                <DropdownMenuItem>
                  <Link
                    href={`/dashboard/quotes/edit/${quote.id}`}
        ...
        <div className="py-4 pl-6 pr-6 md:pr-4 space-y-8">
          ...
          <div>
            <div className="flex flex-col items-center justify-center">
              <div className="flex items-center gap-2 px-3 py-2 bg-slate-200 rounded-full">
                ...
                <p className="text-base text-black font-regular">Devis</p>
              </div>
          ...
          <div>
            ...
            <Button
              ...
              asChild
            >
              <Link href={`/dashboard/customers/overview/${quote.customer.id}`}>
