...
import { Quote, QuoteItem, Customer, Organization } from "@prisma/client";
...
export const QuotePDF = ({ quote }: Props) => {
          ...
          >
            ...
            <Text
              ...
              render={({ pageNumber, totalPages }) =>
                `Page ${pageNumber} / ${totalPages} de le devis ${quote.number}`
              }
            />
          </View>
        </View>
